...
<html>
    ...
    <body class="dash">
                                ...
                                <div class="panel-body">
                                    <div class="col-lg-12">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <%
                                                    try {
                                                        ...
                                                        PreparedStatement ps = con.prepareStatement("SELECT names,username,pos,phone,managed_by FROM employee "
                                                                + "WHERE compName = ? ");
                                                        ps.setString(1, comp);
                                                ...
                                                %>
                                                <tr>
                                                    <td><span class="pull-left"><%=rs.getString("names")%></span></td>
                                                    <td><span class="pull-left"><%=rs.getString("username")%></span></td>
                                                    <td><span class="pull-left"><%=rs.getString("pos")%></span></td>
                                                    <td><span class="pull-left"><%=rs.getString("phone")%></span></td>
                                                    <td><span class="pull-left"><%=rs.getString("managed_by")%></span></td>
                                                    <td><input type="checkbox" class="form-control form-control staffCheck"></td>
                                                </tr>
                                                <%  }
                                                    } catch (Exception e) {
                                                        e.printStackTrace();
                                            ...
                                            <input id="Delete-staff" type="submit" value="DELETE" class="btn btn-group btn-primary btn-md" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            $('.staffCheck').click(function(){
                $('#Delete-staff').attr("disabled", !this.checked);
            });
        </script>
    </body>
</html>