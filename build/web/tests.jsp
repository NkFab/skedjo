                                ...
                                <div class="panel-body">
                                    <div class="col-lg-7">
                                        <form class="form-header" action ="#" method="post">
                                            <ul>
                                                <li><label for=”password”>Current Password:          </label><input id=”password” class="from-group form-control input-md" type=”password” name=”password” /></li><br>
                                                <li><label for=”password”>Retype  Password:  </label><input id=”verify” class="from-group form-control input-md" type=”password” name=”password” /><span id=”verifynote” class=”warn" hidden>Password do not match</span></li><br>
